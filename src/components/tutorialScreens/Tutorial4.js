...
import { CarImg } from "./imageForTutorial/imgForTutorial_4/CarImg"

export const Tutorial4 = (props) => {
    return (
        ...
        <View style={styles.content}>
            ...
            <View style={styles.bottomBlock}>
                <View style={styles.text2}>
                    <Text style={[styles.nameAppText, { textAlign: "center" }]}>Free Pick Up</Text>
                </View>


                <View style={styles.blockWithlittleText}>
                    <Text style={styles.littleText}>
                    Ultrices mattis tempus ante massa lectus.
                    </Text>
                </View>
